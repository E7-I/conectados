const Home = () => {
  return (
    <div className="pattern-bg bg-cover bg-center flex items-center justify-center">
      <div className="bg-gradient-to-br from-blue-50 to-white w-full py-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 mb-12 max-w-2xl mx-auto">
            Encuentra profesionales confiables para servicios como Belleza, Gasfiteria, Jardineria, Limpieza y mucho más.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border hover:shadow-2xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-blue-700 mb-2">Buscar Servicios</h3>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border hover:shadow-2xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-blue-700 mb-2">Agenda Online</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border hover:shadow-2xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-blue-700 mb-2">Reseñas Reales</h3>
              <p className="text-gray-600 text-sm">
