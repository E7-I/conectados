...
const ServiciosPage: React.FC = () => {
  ...
  const fetchServicesWithFilters = React.useCallback(async (filters: {
    minPrice?: string
    maxPrice?: string
    category?: string
    minRating?: string
  ...
  const handleFilterSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    fetchServicesWithFilters({ minPrice, maxPrice, category, minRating, searchTerm }, false)
  }
              ...
              <div className="p-6">
                <form onSubmit={handleFilterSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-gray-100 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-200 transition-colors duration-200 font-medium"
                  >
                    Limpiar Filtros
                  </button>{' '}
                </form>
